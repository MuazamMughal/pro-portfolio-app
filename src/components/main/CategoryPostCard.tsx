...
//   return (
//     <div className="flex flex-col md:flex-row gap-6 mb-8 pb-8 border-b border-gray-200 last:border-0">
//       {/* Left side (3/4) - Image, Title, Excerpt */}
...
//       {/* Right side (1/4) - Author and Category */}
